            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={index} className={`animate-fadeInLeft`} style={{ animationDelay: `${index * 0.1}s` }}>
                  <Link to={link.href} className="text-gray-300 hover:text-white transition-all duration-200 transform hover:translate-x-1 inline-block text-sm">
                    {link.text}
                  </Link>
                </li>
              ))}
          ...
          <div className="animate-fadeInUp delay-300">
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={index} className={`animate-fadeInLeft`} style={{ animationDelay: `${index * 0.1}s` }}>
                  <Link to={item.href} className="text-gray-300 hover:text-white transition-all duration-200 transform hover:translate-x-1 inline-block text-sm">
                    {item.text}
                  </Link>
                </li>
              ))}
